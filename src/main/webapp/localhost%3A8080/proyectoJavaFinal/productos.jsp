				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form id="miFormulario" action="GestionPublicacionServlet" method="post"
...
<!-- 									<button type="submit" class="btn btn-primary">Publicar</button> -->
									<button type="button" onclick="enviarFormulario()">Publicar</button>
								</div>
							</form>
						</div>
					</div>
